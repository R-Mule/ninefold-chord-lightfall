...
// ⭐ Fragment obfuscation helper
function j(parts: string[]) {
  return parts.join("");
}
  ...
  return (
    ...
    >
      ...
      <div className="relative z-[100] text-center px-4">
        ...
        >
          {j(["40","4 ","- ","Li","gh","t'","s ","Re","st ","No","t ","Fo","un","d"])}
        </h1>
        ...
        >
          {j(["Th","e ","Wh","is","pe","re","d ","On","e ","ha","s ","re","tu","rn","ed","."])}
        </p>

        <p 
          className="font-['Cooper_Hewitt'] text-[1.5vmin] text-white/60 tracking-[0.2em] mb-8"
        >
          {j(["Th","is ","pl","an","e ","wi","ll ","be ","er","as","ed","."])}
        </p>
        ...
        >
          {j(["ES","CA","PE"," ","TO"," ","A ","SA","FE","R ","PL","AN","E"])} →
        </Link>
      </div>
    </div>
  );
